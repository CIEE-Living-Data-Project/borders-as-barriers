...
Many (but not all!) of the options for installation are command line based, which can be intimidating if you're not used to it. If you encounter any issues installing git, please attend Gracielle's office hours on Thursday, Sept 8th, or contact a postdoc or TA.
